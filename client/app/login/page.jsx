...
const LoginSignup = () => {
  ...
  }, [dispatch, toast, error, isAuthenticated, router, redirect]);
    ...
    <>
      ...
      <section className="grid place-items-center w-full h-full bg-center">
        {loading ? (
          ...
          <Tabs
            className={`bg-gray-200 shadow_black_1 mt-28 mb-10 w-fit rounded-lg p-6 flex justify-center items-center flex-col `}
          >

      ...
      {loading ? (
        ...
        <>
          <section className="profile relative flex justify-center items-center h-screen w-full py-6">
            <Rain />
            <div
              className={`bg-gray-200 shadow_black_1 w-full max-w-md rounded-lg p-6 flex justify-center items-center flex-col relative z-10 mx-3`}
            >
              <div className="relative w-fit ">
                <Link href="/profile/update">
                  <span className="w-9 h-9 cursor-pointer absolute z-30 flex justify-center items-center bottom-0 right-0 rounded-full bg-white">
              ...
              <div className="space-y-2 mt-7">
                <div className="flex items-center">
                  ...
                  <p className="text-lg capitalize satoshi_medium">
                    {user?.name}
                  </p>
                </div>
                <div className="flex items-start">
                  <h1 className="text-lg font-semibold pr-7">Email:</h1>
                  <p className="text-lg break-all satoshi_medium">
                    {user?.email}
                  </p>
                </div>
                <div className="flex items-center">
                  <h1 className="text-lg font-semibold pr-7">Joined on:</h1>
                  <p className="text-lg obviously">
                ...
                <div className="flex items-center gap-x-7 justify-center pt-5">
                  ...
                  <Link href="/password/update" className="">
                    <ButtonTextIcon
                      ...
                      customize="px-2.5 py-1 text-xs transition-all rounded-sm duration-1000 hover:rounded-full"

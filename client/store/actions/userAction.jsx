...
import {
    ...
    LOAD_USER_FAIL, LOAD_USER_REQUEST, LOAD_USER_SUCCESS, CLEAR_ERRORS, LOGIN_FAIL, LOGIN_REQUEST, LOGIN_SUCCESS, REGISTER_FAIL, REGISTER_REQUEST, REGISTER_SUCCESS, LOGOUT_FAIL, LOGOUT_SUCCESS,
    UPDATE_PROFILE_FAIL, UPDATE_PROFILE_REQUEST, UPDATE_PROFILE_SUCCESS, UPDATE_PASSWORD_REQUEST, UPDATE_PASSWORD_SUCCESS, UPDATE_PASSWORD_FAIL,
...
export const login = (userLog) => async (dispatch) => {
    ...
    try {
        ...
        const { data: { user } } = await request.post('/login', userLog, config);
...
export const register = (userReg) => async (dispatch) => {
    ...
    try {
        ...
        const { data: { user } } = await request.post('/register', userReg);
...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await request.put(`/admin/user/${id}`, userData, { headers: { "Content-Type": "application/json" } });
